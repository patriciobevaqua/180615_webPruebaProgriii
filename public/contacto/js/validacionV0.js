...
function validarContacto(formulario){
	...
	/*if(formulario.provincia.value == "-1" || formulario.provincia.value == ""){
	...
	if(formulario.email.value != formulario.repetir_email.value){

		mensaje+="- Los correos electronicos deben ser iguales\n";
	...
	if(formulario.escogido.value != formulario.captcha.value){

		mensaje+="- Debe introducir correctamente el codigo de validacion\n";
...
function cambiarCaptcha(ruta){
	...
	document.getElementById("imagen_captcha").src=ruta+"/modulo_base/includes/aplicaciones/contacto/img/captcha"+imagen+".jpg";
